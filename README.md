<div align="center" style="max-width:100%; padding:0 15px; text-align:center;">
  ...
  <div style="margin:40px 0; width:100%; text-align:center;">
    ...
    <div style="background:#f5e8c7; padding:15px; max-width:80%; margin:20px auto; border-radius:5px 20px; border:1px solid #d4af37; font-family:monospace; color:#5e2c04; font-style:italic; position:relative;">
      ⁜ "Код — как Сила. Доверься ему."<br>
      ⁜ "Капибара-Джедай знает путь Истинного Python"
      <!-- Простые уголки из псевдоэлементов -->

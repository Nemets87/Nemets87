<div style="max-width: 100%; padding: 0 15px; margin: auto;">
  <!-- Заголовок -->
  <header style="text-align: center; margin: 20px 0;">
    <img src="https://readme-typing-svg.demolab.com?font=Space+Mono&size=26&duration=4000&pause=1000&color=45FFB8&width=100%25&lines=%F0%9F%94%A5+Greetings%2C+Code+Jedi!;%F0%9F%92%BB+Python+Architect;%F0%9F%93%82+Linux+Artisan;%E2%9C%A8+May+The+Code+Be+With+You" 
         alt="Анимированный заголовок">
  </header>

  <!-- Аватар -->
  <section style="display: flex; justify-content: center; margin: 25px 0;">
    <img src="https://raw.githubusercontent.com/Nemets87/Nemets87/main/photo_2025-02-12_08-53-12.jpg" 
         alt="Аватар" 
         style="width: 320px; height: 320px; border-radius: 50%; border: 4px solid #45ffb8; box-shadow: 0 0 40px #22f7f7; object-fit: cover;">
  </section>

  <!-- Бейджи -->
  <section style="display: flex; flex-wrap: wrap; gap: 15px; justify-content: center; margin: 30px 0;">
    <a href="https://www.bonustime.ru/" target="_blank" rel="noopener noreferrer">
      <img src="https://img.shields.io/badge/🌐_WEBSITE-FFD700?style=for-the-badge&logo=google-chrome&logoColor=000" alt="Website Badge">
    </a>
    <a href="https://python.org" target="_blank" rel="noopener noreferrer">
      <img src="https://img.shields.io/badge/Python-Master-3776AB?style=for-the-badge&logo=python&logoColor=ffdd54" alt="Python Badge">
    </a>
    <a href="https://t.me/FedorovSFF" target="_blank" rel="noopener noreferrer">
      <img src="https://img.shields.io/badge/📡_Telegram-26A5E4?style=for-the-badge&logo=telegram&logoColor=white" alt="Telegram Badge">
    </a>
  </section>
  ...
  <!-- Прогресс-бары -->
  <section style="max-width: 600px; margin: 30px auto; padding: 20px; background: #0d1117dd; border-radius: 15px; backdrop-filter: blur(5px);">
...
! Code Balance   ▰▰▰▰▰▰▰▰▰▰ 100%
  ...
  <!-- Контакты -->
  <footer style="display: flex; flex-wrap: wrap; gap: 15px; justify-content: center; margin: 40px 0;">
